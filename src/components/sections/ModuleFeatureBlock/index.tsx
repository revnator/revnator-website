...
import type { ModuleFeatureBlockData } from './Data'
...
export function ModuleFeatureBlock({
  data,
  reverse = false,
}: {
  data: ModuleFeatureBlockData
  reverse?: boolean
}): React.ReactElement {
  ...
  return (
    <section className={cn('py-20', bgClass)}>
      <div className="mx-auto max-w-container px-6 md:px-12">
        <div
          className={cn(
            'grid grid-cols-1 lg:grid-cols-2 items-center gap-12 lg:gap-16',
        ...
        >
          ...
          <div className={cn(reverse && 'lg:[direction:ltr]')}>
            ...
            <p className="mt-4 font-body text-base leading-[1.7] text-body max-w-[460px]">
              {data.description}
            </p>
