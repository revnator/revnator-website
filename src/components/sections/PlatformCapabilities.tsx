...
export function PlatformCapabilities({ capabilities }: { capabilities: CapabilityData[] }): React.ReactElement {
  return (
          ...
          {capabilities.map((card) => (
            ...
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-light">
                <DynamicIcon name={card.icon} size={24} className="text-primary" />
              </div>
