...
import { supportFAQs } from '../_support/supportData'

export function SupportFAQ(): React.ReactElement {
  ...
  return (
    <section className="bg-bg py-20">
      <div className="mx-auto max-w-prose-narrow px-6 md:px-12">
        <h2 className="text-center font-heading text-[28px] font-bold text-dark tracking-[-0.01em]">
