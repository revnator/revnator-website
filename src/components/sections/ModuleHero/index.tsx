...
import type { ModuleHeroData } from './Data'
...
export function ModuleHero({ data }: { data: ModuleHeroData }): React.ReactElement {
  return (
    <section className="bg-bg pt-12 pb-20">
      <div className="mx-auto max-w-container px-6 md:px-12">
        {/* Breadcrumb */}
        <nav className="mb-8 flex items-center gap-1 font-body text-[13px]">
          <Link href={data.breadcrumbParentHref} className="text-primary hover:underline">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[55%_45%] items-center gap-12 lg:gap-16">
          ...
          <div>
            ...
            <h1 className="mt-5 font-heading text-h1 font-bold leading-[1.15] tracking-[-0.02em] text-dark max-w-[520px]">
              {data.heading}
            </h1>

            <p className="mt-5 font-body text-[17px] leading-[1.7] text-body max-w-[480px]">
              {data.description}
            </p>
