...
export function WhyHero(): React.ReactElement {
  return (
    <section className="relative overflow-hidden bg-dark py-20">
      ...
      <div className="relative z-10 mx-auto max-w-container px-6 text-center md:px-12">
        ...
        <h1 className="mx-auto mt-6 max-w-[700px] font-heading text-[44px] font-bold leading-[1.12] tracking-[-0.02em] text-white">
          The sales OS that replaces your entire stack
        </h1>

        <p className="mx-auto mt-5 max-w-[580px] font-body text-lg text-white/55">
          Most sales teams juggle 5-7 tools. Revnator gives you everything in one
          workspace — CRM, sequences, pipeline, calendar, analytics, and AI.
        </p>
